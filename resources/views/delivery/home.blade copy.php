    ...
    <div class="row">
        <div class="col-md-8">
            <div class="containerw">
                <div class="bg-sky text-white px-2 rounded">
                    <p class="fs-5 py-2">1. Pilih Destinasi</p>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-4 mb-2">
                        <div class="card card-customer" data-uuid="{{ $destination->uuid }}">
                            <div class="card-body">
                                <p class="fs-6 mb-0 fw-bold">{{ $destination->name }}</p>
                                <p class="fw-light mb-0">{{ $destination->other_name }}/{{ $destination->dock }}</p>
                                {{-- <p class="fw-bold mb-0"></p> --}}
                                <p class="text-muted" style="font-size: 10pt;">Logistic: {{ $destination->logistic }}</p>
                            </div>
                        </div>
                    </div>
                    @endforeach
                ...
                <div class="bg-sky text-white px-2 rounded">
                    <p class="fs-5 py-2">2. Pilih Cycle</p>
                </div>
                <div class="row">
                    @for($i=1;$i<=12;$i++)
        ...
        <div class="col-md-4">
            <div class="row">
                <div class="col-md-12 text-center">
                    <div class="bg-sky text-white px-2 rounded">
                        <p class="fs-5 py-2">3. Foto Selfie</p>
                    </div>
                    <div id="webcam" class="" style="height:300px">
                    </div>
                    <img id="captured-photo" style="display: none;">
                    <button class="take-photo btn btn-light border mt-3">
        ...
        <div class="col-md-12 mt-4">
            ...
            <button class="btn btn-success w-100 py-3 mt-2 fw-bold fs-5">
                Lanjut ke Pulling
            </button>
            </form>
        </div>
