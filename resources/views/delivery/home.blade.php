                            ...
                            <div class="col-md-4 mb-2">
                                <div class="card card-customer" data-uuid="{{ $destination->uuid }}">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="fw-light mb-0" style="font-size: 10pt;">Logistic:
                                            {{ $destination->logistic }}</p>
                                    </div>
                                </div>
                            </div>
                        @endforeach
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="text-center">
                            ...
                            <button class="retake-photo btn btn-danger mt-2" style="display: none;">
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-refresh"
                                    ...
                                    <path d="M7 21a8.7 8.7 0 0 1 -4.5 -1.3" />
                                    <path d="M15 3a8.7 8.7 0 0 1 4.5 1.3" />
                                </svg>
                                Photo Ulang
                            </button>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.retake-photo').on('click', function() {
                // Hide captured photo and show webcam
                $('#captured-photo').css('display', 'none');
                $('#webcam').css('display', 'block');

                // Show take-photo button and hide retake button
                $('.take-photo').show();
                $('.retake-photo').hide();
